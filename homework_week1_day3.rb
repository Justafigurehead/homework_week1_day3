...
# puts stops.index("Buchanan Street")
...
#puts my_hero[:weight][1]


# 5. Get the number of weapons the hero has

# for weapons in my_hero
#  puts "#{my_hero[:name]} has #{weapons.length} weapons."
# end
...
big_animals.each {|key, value| puts "#{key} and #{value}" }
...
# for meat in big_animals
#   if (big_animals[:carnivore] == true)
#     puts "#{big_animals[:name]} is a carnivore."
#   else
#     puts "#{big_animals[:carnivore] != true} is not a meat eater!"
#   end
# end
